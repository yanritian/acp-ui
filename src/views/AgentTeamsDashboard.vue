...
import AgentRealtimeProgressPanel from '@/components/agent-progress/AgentRealtimeProgressPanel.vue'
import AgentPetAvatar from '@/components/agent-pet/AgentPetAvatar.vue'
import EmotionDisplay from '@/components/agent-pet/EmotionDisplay.vue'
import GrowthSystem from '@/components/agent-pet/GrowthSystem.vue'
import InteractionPanel from '@/components/agent-pet/InteractionPanel.vue'
